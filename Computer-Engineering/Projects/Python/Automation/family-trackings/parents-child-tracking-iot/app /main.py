...
def main(page: ft.Page):
    ...
    def route_change(e):
        ...
        # 2. Demais telas exigem que o Dashboard esteja na base da pilha se viemos dele
        elif page.route in ["/dashboard", "/add-device", "/tracking"]:
            # Adiciona o Dashboard como base da navegação interna
            page.views.append(
                ft.View(
                    "/dashboard",
                    [
                                            ...
                                            content=ft.Column([
                                                ...
                                                ft.Row([
                                                    ft.Button(
                                                        ...
                                                        on_click=lambda _: page.run_task(page.push_route, "/tracking")
                                                    ),
            ...
            # 3. Tela de Adicionar Dispositivo (Empilhada sobre o Dashboard)
            if page.route == "/add-device":
            ...
            # 4. Tela de Rastreamento (Empilhada sobre o Dashboard)
                                    ...
                                    [
                                        ...
                                        ft.Card(
                                            content=ft.Container(
                                                content=ft.Column([
                                                    ft.ListTile(
                                                        leading=ft.Icon(ft.Icons.LOCATION_ON, color=ft.Colors.INDIGO),
                                                        title=ft.Text("João - Escola (Escola Municipal João Paulo II)"),
                                                        subtitle=ft.Text("Atualizado há 5 minutos • Precisão: Alta"),
                                                    )
                                                ]),
                                                padding=15
                                            )
    ...
    # Atribuindo os eventos essenciais ao objeto page
